...
import { resolveChannelIcon } from '@/lib/model-logo'
...
function ChannelRow({ channel, onEdit, onDelete, onToggle }: ChannelRowProps): React.ReactElement {
  ...
  return (
    <SettingsRow
      label={channel.name}
      icon={<img src={resolveChannelIcon(channel.iconUrl, channel.baseUrl, channel.provider)} alt="" className="w-8 h-8 rounded" />}
